...
public class GroupInfoAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, final ViewGroup viewGroup) {
        ...
        if (info.getMemberType() == ADD_TYPE) {
            ...
            holder.memberIcon.setOnClickListener(view1 -> {
                AuthorModel authorModel = new AuthorModel(info.getAccount());
                PluginManager.get(AccountPlugin.class).startPgcActivity(view1,authorModel);
            });
        }
