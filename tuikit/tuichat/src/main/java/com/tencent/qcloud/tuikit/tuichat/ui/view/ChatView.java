...
public class ChatView extends LinearLayout  implements IChatLayout {
    ...
    public void setChatInfo(ChatInfo chatInfo) {
        ...
        if (isGroup) {
            ...
            getTitleBar().getRightIcon().setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View view) {
                    AuthorModel authorModel = new AuthorModel(chatInfo.getId());
                    PluginManager.get(AccountPlugin.class).startPgcActivity(getTitleBar().getRightIcon(),
                            authorModel);
                }
            });
        }
