...
import com.hzlz.aviation.feature.community.databinding.FragmentFindCircleItemBinding;
import com.hzlz.aviation.feature.community.viewmodel.HomeFindCommunityViewModel;
        ...
        if (!UserManager.hasLoggedIn()) {
            ...
            if (plugin != null) {
                ...
                GVideoSensorDataManager.getInstance().enterRegister(
                        ...
                        ResourcesUtils.getString(com.hzlz.aviation.feature.account.R.string.follow)
                );
            }
            return;
        }
