 ...
 * 搜索页面空白占位footer view
 */
public class CircleBlankRefreshFooterView extends FrameLayout implements RefreshFooter {

  public CircleBlankRefreshFooterView(@NonNull Context context) {
    super(context);
    initView(context);
  }

  public CircleBlankRefreshFooterView(@NonNull Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
    initView(context);
  }
