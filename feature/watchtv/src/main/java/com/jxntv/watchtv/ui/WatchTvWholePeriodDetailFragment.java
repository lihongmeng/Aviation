...
import static com.jxntv.base.model.anotation.MediaType.COLLECTION_DETAIL;
...
import com.jxntv.android.video.ui.vshort.VideoWholePeriodController;
import com.jxntv.android.video.ui.vsuper.info.VideoSuperInfoViewModel;
...
import com.jxntv.watchtv.databinding.FragmentWatchTvWholePeriodDetailBinding;
import com.jxntv.watchtv.entity.ColumnGroupInfo;
import com.jxntv.watchtv.ui.select.SelectCollectionFragment;
        ...
        mBinding.inputPanel.audioComment.setOnClickListener(
                v -> {
                    if (checkCanNotComment()) {
                        showToast(com.jxntv.android.video.R.string.video_comment_cant_comment);
                        return;
                    }
