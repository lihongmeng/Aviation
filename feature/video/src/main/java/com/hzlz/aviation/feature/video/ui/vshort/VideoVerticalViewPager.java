...
public class VideoVerticalViewPager extends ViewGroup {
  ...
  // on touch down and let the user interact with the mContent inside instead of
  ...
  public VideoVerticalViewPager(Context context, AttributeSet attrs) {
    super(context, attrs);
    initViewPager();
  }
    ...
    switch (action) {
      case MotionEvent.ACTION_MOVE: {
        ...
        if (activePointerId == INVALID_POINTER) {
          // If we don't have a valid id, the touch down wasn't on mContent.
          break;
        }
