...
public class DetailViewModel<CommentModel> extends BaseRecyclerViewModel<CommentModel> implements IRecyclerModel<CommentModel> {
    ...
    public void insert(int position, CommentModel commentModel,
        ...
        observable.subscribe(new GVideoResponseObserver<CommentModel>() {
            ...
            protected void onSuccess(@NonNull CommentModel response) {
                ...
                if (response instanceof com.hzlz.aviation.kernel.base.model.comment.CommentModel) {
                    com.hzlz.aviation.kernel.base.model.comment.CommentModel model = (com.hzlz.aviation.kernel.base.model.comment.CommentModel) response;
                ...
                if (response instanceof com.hzlz.aviation.kernel.base.model.comment.ReplyModel) {
                    com.hzlz.aviation.kernel.base.model.comment.ReplyModel model = (com.hzlz.aviation.kernel.base.model.comment.ReplyModel) response;
                    if (!TextUtils.isEmpty(localFilePath) && TextUtils.isEmpty(model.soundUrl)) {
                        model.soundUrl = localFilePath;
                        response = (CommentModel) model;
                        localFilePath = "";
    ...
    private void setStat(CommentModel commentModel, @InteractType int interactType, String error) {
        ...
        if (commentModel instanceof com.hzlz.aviation.kernel.base.model.comment.CommentModel) {
            com.hzlz.aviation.kernel.base.model.comment.CommentModel model = (com.hzlz.aviation.kernel.base.model.comment.CommentModel) commentModel;
        ...
        if (commentModel instanceof com.hzlz.aviation.kernel.base.model.comment.ReplyModel) {
            com.hzlz.aviation.kernel.base.model.comment.ReplyModel model = (com.hzlz.aviation.kernel.base.model.comment.ReplyModel) commentModel;
