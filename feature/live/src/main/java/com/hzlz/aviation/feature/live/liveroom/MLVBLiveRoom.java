...
public abstract class MLVBLiveRoom {
     ...
     * @param listener
     */
    public abstract void setAudioVolumeEvaluationListener(TXLivePusher.ITXAudioVolumeEvaluationListener listener);

    public abstract void enableAudioVolumeEvaluation(int intervalMs);
     ...
     */
    public abstract void createRoom(final boolean isPureAudio,final String roomID, final String roomInfo, final IMLVBLiveRoomListener.CreateRoomCallback callback);
     ...
     */
    public abstract void enterRoom(final String roomID, final TXCloudVideoView view, String playUrl, final IMLVBLiveRoomListener.EnterRoomCallback callback);
     ...
     * @param callback 进入房间的结果回调
     */
    public abstract void enterRoom(final String roomID, String authorId, final TXCloudVideoView view, String playUrl, final IMLVBLiveRoomListener.EnterRoomCallback callback);
    /**
     * 离开房间
     *
     ...
     */
    public abstract void requestJoinAnchor(String reason, int position, IMLVBLiveRoomListener.RequestJoinAnchorCallback callback);
     ...
     */
    public abstract int responseJoinAnchor(String userID, int index, boolean agree, String reason);
     ...
     * @param view        承载视频画面的控件
     */
    public abstract void startLocalPreview(boolean frontCamera, boolean isPureAudio, TXCloudVideoView view);
     ...
     * 开启纯音频模式
     */
    public abstract void enablePureAudio();

    /**
     * 关闭纯音频模式
     */
    public abstract void disablePureAudio();
     ...
     * 暂停推流
     */
    public abstract void onPausePusher();

    /**
     * 恢复推流
     */
    public abstract void onResumePusher();
     ...
     * @see {@link IMLVBLiveRoomListener#onReceiveRoomTextMsg(String, String, String, String, String)}
     */
     ...
     * @param message  文本消息
     * @param callback 发送结果回调
     * @see {@link IMLVBLiveRoomListener#onReceiveRoomCustomMsg(String, String, String, String, String, String)}
     */
