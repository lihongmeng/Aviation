...
public class GVideoViewfinderView extends ViewfinderView {
    ...
    public GVideoViewfinderView(Context context, AttributeSet attrs) {
        super(context, attrs);
        alignHeight = (ScreenUtils.getScreenHeight(context) / 2) -50;
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (framingRect.bottom > alignHeight) {
            int dif = framingRect.bottom - alignHeight;
            framingRect.bottom = alignHeight;
            previewFramingRect.bottom = alignHeight;

            framingRect.top -= dif;
            previewFramingRect.top -= dif;
        }
