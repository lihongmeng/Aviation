 ...
 * 小窗控制器
 */
public class GVideoControllerSmall extends GVideoControllerBase {
  private LiteavControllerSmallBinding mBinding;
  public GVideoControllerSmall(Context context, AttributeSet attrs) {
    super(context, attrs);
  }

  public GVideoControllerSmall(Context context) {
    super(context);
  }
