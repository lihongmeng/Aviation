...
import com.hzlz.aviation.kernel.liteav.controller.GVideoControllerSmall;
import com.hzlz.aviation.kernel.liteav.controller.VideoControllerView;
...
import com.hzlz.aviation.kernel.liteav.player.GVideoPlayer;
import com.hzlz.aviation.kernel.liteav.player.GVideoPlayerListener;
import com.hzlz.aviation.kernel.liteav.player.GVideoPlayerListenerProxy;
import com.hzlz.aviation.kernel.liteav.view.CoverView;
import com.hzlz.aviation.kernel.liteav.view.PendantView;
import com.hzlz.aviation.kernel.runtime.GVideoRuntime;
import com.hzlz.aviation.library.util.LogUtils;
import com.hzlz.aviation.library.util.ScreenUtils;
import com.hzlz.aviation.library.videocache.common.PreloadManager;
    ...
    private final SensorEventListener sensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            if (x > 7.0 && -4.0 < y && y < 4.0) {
                ...
                /**
                 * 如果当前是竖屏状态，就需要切换成横屏
                 * 但是通过{@link ScreenUtils#isFullScreen(Activity)}方法
                 * 判断而得的fullscreen有时不准
